          ...
          <div class="card">
            <div class="card-body">
             <div class="row">
                ...
                <div class="col-lg-11">
                    <div class="profile-name"><h2>Vincentius Gandhi</h2></div>
                    <div class="profile-type">Supplier</div>
                    <div><a href="{{route('supplierShowEditProfile')}}" class="btn btn-primary btn-sm">Edit Profile</a></div>
                </div>
             </div>
             <hr class="my-4">
             ...
             <div class="pl-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control" value="vgandhi075@gmail.com" disabled>
                </div>
                <div class="form-group">
                  <label for="phone-number" class="form-control-label">Phone Number</label>
                  <input type="text" name="phone-number" class="form-control" value="087711031166" disabled>
                </div>
                <div class="form-group">
             ...
             <div class="pl-lg-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="bank-account-number" class="form-control" value="8720309322" disabled>
                </div>
                <div class="form-group">
                  <label for="bank-account-name" class="form-control-label">Bank Account Name</label>
                  <input type="text" name="bank-account-name" class="form-control" value="VINCENTIUS GANDHI DJATMIKO" disabled>
                </div>
             </div>
            </div>
          </div>
